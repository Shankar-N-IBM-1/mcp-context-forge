...
from mcpgateway.db import SessionLocal, Server, Tool
...
class CheckRuntimeHealthActivity(AbstractScheduledActivity):
    ...
    async def perform(self) -> None:
        ...
        try:
            ...
            logger.info(
                f"Runtime health check passed - "
                f"servers: {server_count}, tools: {tool_count}, "
    ...
    def get_health_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "is_healthy": (
                self._last_cpu_percent < 90 and
                self._last_memory_percent < 90
            ),
